...
public class ProductPanel extends JPanel implements ActionListener {
    ...
    public ProductPanel(Customer customer, Product product) {
        ...
        JLabel imageLabel = new JLabel(new ImageIcon(
                new ImageIcon(product.getImagePath()).getImage().getScaledInstance(160, 190, Image.SCALE_SMOOTH)));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == addToCartButton) {
            ...
            if (selectedQuantity == 0) {
                JOptionPane.showMessageDialog(null, "Please select a quantity greater than 0.", "Invalid Quantity",
            ...
            if ((currentQuantity + selectedQuantity) <= product.getStock()) {
                ...
                JOptionPane.showMessageDialog(null, "Product added to cart: " + product.getName(), "Success",
                        JOptionPane.INFORMATION_MESSAGE);

            } else {
                JOptionPane.showMessageDialog(null, "Maximum quantity you can buy is: " + product.getStock(),
                        "No More in Stock", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
